...
public class Hafalan18 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hafalan18);

        ListView listView = (ListView) findViewById(R.id.listHafalan17);
    ...
    private ArrayList<Item2> generateItemList() {
        String itemNames[] = getResources().getStringArray(R.array.name_hafal17);
        String itemDescription[] = getResources().getStringArray(R.array.description_hafal17);
