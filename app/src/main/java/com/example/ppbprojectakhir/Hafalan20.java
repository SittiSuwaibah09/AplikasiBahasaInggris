...
public class Hafalan20 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hafalan20);

        ListView listView = (ListView) findViewById(R.id.listHafalan19);
    ...
    private ArrayList<Item2> generateItemList() {
        String itemNames[] = getResources().getStringArray(R.array.name_hafal19);
        String itemDescription[] = getResources().getStringArray(R.array.description_hafal19);
