...
public class Hafalan22 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hafalan22);

        ListView listView = (ListView) findViewById(R.id.listHafalan21);
    ...
    private ArrayList<Item2> generateItemList() {
        String itemNames[] = getResources().getStringArray(R.array.name_hafal21);
        String itemDescription[] = getResources().getStringArray(R.array.description_hafal21);
