...
public class VocabularyAnimalName extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_vocabulary_animal_name);

        ListView listView = (ListView) findViewById(R.id.listVocabulary9);
    ...
    private ArrayList<Item2> generateItemList() {
        String itemNames[] = getResources().getStringArray(R.array.name_vocab9);
        String itemDescription[] = getResources().getStringArray(R.array.description_vocab9);
