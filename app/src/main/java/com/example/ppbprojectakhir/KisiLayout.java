...
public class KisiLayout extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kisi_layout);

        ListView listView = (ListView) findViewById(R.id.listKisi);
    ...
    private ArrayList<Item2> generateItemList() {
        String itemNames[] = getResources().getStringArray(R.array.name_kisi);
        String itemDescription[] = getResources().getStringArray(R.array.description_kisi);
