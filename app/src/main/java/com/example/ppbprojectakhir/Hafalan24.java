...
public class Hafalan24 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hafalan24);

        ListView listView = (ListView) findViewById(R.id.listHafalan23);
    ...
    private ArrayList<Item2> generateItemList() {
        String itemNames[] = getResources().getStringArray(R.array.name_hafal23);
        String itemDescription[] = getResources().getStringArray(R.array.description_hafal23);
