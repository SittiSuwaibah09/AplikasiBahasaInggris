...
public class VocabularyAdverb extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_vocabulary_adverb);

        ListView listView = (ListView) findViewById(R.id.listVocabulary4);
