...
public class VocabularyWeather extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView listView = (ListView) findViewById(R.id.listVocabulary13);
    ...
    private ArrayList<Item2> generateItemList() {
        String itemNames[] = getResources().getStringArray(R.array.name_vocab13);
        String itemDescription[] = getResources().getStringArray(R.array.description_vocab13);
