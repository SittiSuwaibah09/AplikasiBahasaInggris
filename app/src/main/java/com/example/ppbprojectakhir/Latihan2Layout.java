...
public class Latihan2Layout extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_latihan2_layout);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    Intent intent = new Intent(Latihan2Layout.this, QuizActivity1.class);
    ...
    private ArrayList<Item1> generateItemList() {
        String itemNames[] = getResources().getStringArray(R.array.items_name5);
